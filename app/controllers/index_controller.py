...
def view_doctors():
    ...
    for doctor in Doctors.db_doctors:
    ...
    Doctors.db_doctors.close()                      # Cierro el cursor que se abre al buscar dentro de mongo
    return list_doctors
...
def view_clinics():
    ...
    for clinic in Clinics.db_clinics:
    ...
    Clinics.db_clinics.close()                       # Cierro el cursor que se abre al buscar dentro de mongo
    return list_clinics
